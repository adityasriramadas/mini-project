            ...
            <div>
                 ...
                 <header>
                    ...
                    <nav className="navbar navbar-expand-lg navStyle sticky-top">
                        ...
                        <button type='button ' onClick={this.toggleNavbar} className={`${classTwo}`} data-toggle='collapse' data-target="#mainMenu" aria-controls="mainMenu" aria-expanded="false" aria-label="Toggle navigation">
                            <span><i className="fa fa-align-right iconStyle"></i></span>
                        </button>

                        <div className={`${classOne}`} id="mainMenu" onClick={this.toggleNavbar}>
